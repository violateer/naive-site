      ...
      <n-form ref="formRef" :model="model" :rules="rules" size="medium" label-placement="top">
        <n-grid :cols="24" :x-gap="24">
          ...
          <n-form-item-gi :span="24" label="密码" path="password">
            <n-input type="password" show-password-on="mousedown" placeholder="password..." :maxlength="8" v-model:value="model.password">
...
import { RenderHelper } from '../../router/renderHelper'
